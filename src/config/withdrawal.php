...
return [
    ...
    |--------------------------------------------------------------------------
    | Источник средств для исходящих транзакций. Phase 6.1 ставит каркас;
    | Phase 6.2 будет резолвить (address, hd_seed_ref, path) при первом
    | обращении через SigningClient::deriveAddress.
    */
    'hot_wallets' => [
        'bitcoin-regtest' => [
