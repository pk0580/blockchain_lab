 ...
 * подписания на Go через общий bearer-токен. Таймауты, повторные попытки и
 * отображение ошибок (наподобие автоматического размыкателя цепи / circuit-breaker)
 * находятся здесь, чтобы слой Domain никогда не видел типы Laravel HTTP.
 */
