 ...
 * если тот будет архивирован). Связь с кошельком пока опциональна (`walletId`
 * nullable); привязка через отдельный use-case AssignAddressToWallet может
 * быть добавлена позже.
 */
final class Address
{
    /** @var list<object> */
