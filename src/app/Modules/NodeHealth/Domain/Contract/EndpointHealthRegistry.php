...
/**
 * Хранилище последних наблюдений по endpoint'ам. Текущая реализация хранит в
 * Cache (Redis prod / array tests). Контракт абстрактный — реализацию можно
 * заменить на PG-таблицу для исторического трендового анализа без правок Application.
 *
